				...
				<div class="container">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">edit kriteria</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li class="active"><span>edit-kriteria</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
						...
						<div class="col-sm-12">
							<div class="panel panel-default border-panel card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Form edit kriteria</h6>
									</div>
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form role="form" class="form-horizontal" method="post" action="<?php echo base_url('index.php/admin/updateKriteria')?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_aspek" class="selectpicker" data-style="form-control btn-default btn-outline" required>
                                                        <option value="<?php echo $kriteria->id_aspek; ?>"><?php echo $kriteria->nama_aspek; ?> </option>
                                                        <?php 
                                                ...
                                                <div class="form-group">
													...
													<div class="col-sm-6">
														<input type="text" id="example-input-normal" name="nama_kriteria" class="form-control" value="<?php echo $kriteria->nama_kriteria; ?>" required>
													</div>
												</div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="tipe" class="selectpicker" data-style="form-control btn-default btn-outline" required>
                                                        <option value="<?php echo $kriteria->tipe; ?>"><?php if($kriteria->tipe == 'SF'){
                                                                echo "Secondary Factor"; } else { echo " Core Factor";} ?></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="nilai_target" class="selectpicker" data-style="form-control btn-default btn-outline" required>
                                                        <option value="<?php echo $kriteria->nilai_target; ?>"> <?php echo $kriteria->nilai_target; ?> </option>
                                                ...
                                                <div class="form-group">
													...
													<div class="col-sm-6">
														<input type="text" id="example-input-normal" name="bobot_evaluasi" class="form-control" value="<?php echo $kriteria->bobot_evaluasi; ?>" required>
													</div>
												</div>
                                                <div class="form-group">

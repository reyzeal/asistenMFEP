					...
					<div class="row heading-bg">
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li class="active"><span>tambah-sesi</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
						...
						<div class="col-sm-12">
							<div class="panel panel-default border-panel card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Form tambah sesi</h6>
									</div>
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form role="form" class="form-horizontal" method="post" action="<?php echo base_url('index.php/admin/insertSesi')?>">
												
												<div class="form-group">
													<label class="col-sm-3 control-label " for="example-input-normal">Nama Sesi</label>
													<div class="col-sm-6">
														<input type="text" id="example-input-normal" name="nama_sesi" class="form-control" placeholder="Nama Sesi" required>
													</div>
												</div>
                                                <div class="form-group">

											...
											<table id="example" class="table table-hover display  pb-30" >
												...
												<tbody>
													...
													<tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url('index.php/admin/editAdmin/'.$data->id_admin) ?>"> <button class="btn btn-primary btn-icon-anim btn-circle"><i class="fa fa-pencil"></i></button></a>

        ...
        <div class="container">
            ...
            <div class="row heading-bg">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h5 class="txt-dark">Pengambilan Keputusan</h5>
                </div>
                <!-- Breadcrumb -->
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><span>Pengambilan Keputusan</span></li>
                    </ol>
                </div>
                <!-- /Breadcrumb -->
            </div>
                                            ...
                                            <table id="dtDynamicVerticalScrollExample" class="table table-striped table-bordered table-sm">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Nama Lengkap</th>
                                                        <th>IPK</th>
                                                        <th>Total Nilai Profile matching</th>
                                                        <th>Opsi</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        ?>
                                                            <a href="<?php echo base_url('index.php/admin/detail_perhitungan/'.$data->id_pendaftaran) ?>"><span class='label label-success'>Detail Penilaian</span></a>
                    ...
                    <div class="panel panel-default card-view">
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body pt-0">
                                <div class="table-wrap">
                                    <div class="table-responsive">
                                        <h5 class="txt-dark">Ranking Nilai Multi Factor Evaluation Process</h5>
                                        <br>
                                        <div id="main" align="center">
                            ...
                            <div class="panel-body pt-0">
                                <div class="table-wrap">
                                    <div class="table-responsive">
                                        ...
                                        <br>
                                        <div id="main" align="center">
                                            <form method="post" action="<?php echo base_url('index.php/admin/pengambilankeputusan')?>">
                                            <table id="dtDynamicVerticalScrollExample" class="table table-striped table-bordered table-sm">
                                                <thead>
                                                    <tr><th  align="center"><input type="checkbox" id="pilihsemua"></th>
                                                        <th>Ranking</th>
                                                        <th>NIM</th>
                                                        <th>Nama Lengkap</th>
                                                        <th>IPK</th>

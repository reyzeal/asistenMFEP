            ...
            <div class="row heading-bg">
                ...
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><span>Multi Factor Evaluation Process</span></li>
                    </ol>
                </div>
                <!-- /Breadcrumb -->
            </div>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><?php echo $data->nim ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
														<a href="<?php echo base_url('index.php/admin/detail_mfep/'.$data->id_pendaftaran) ?>"><span class='label label-success'>Detail Penilaian</span></a>
                                                        
                                                        <?php
                                                    } else{ ?><a href="<?php echo base_url('index.php/admin/detail_mfep/'.$data->id_pendaftaran) ?>"><span class='label label-danger'>Belum</span></a>
													<?php } ?>
                                                    </td>
